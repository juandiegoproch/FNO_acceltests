...
/* Heap derivado de las dimensiones: cubre exactamente los cinco buffers
 * del layout (A0,W1,C1,W2,C2) + 4096 B de margen, asi el chequeo
 * "no cabe en el heap" nunca dispara al variar SZCH. A L=4096 (SZCH=64)
 * son 246336 B de datos + 4096 B de margen = 250432 B (~245 KiB). */
